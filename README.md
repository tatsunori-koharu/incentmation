...
## アプリケーションの概要
incentmationはinformation(情報)とconcentration(集中する)を合わせた造語の意味通り、情報を集中させるサイトを目指しています。<br/>
世間的にあまり知られていない方々のための情報の共有ができるコミュニティーサイトをとなっております。<br/>
具体的には、</br>
### １.業界内の最新情報の共有</br>
その業界での最新の情報や動向を投稿することにより、広く情報の共有ができます。
### ２.困っていることの相談</br>
各現場で困っている事を投稿することにより、投稿記事を見た様々な方の意見を聞くことができ早期の問題解決を実現します。</br>
### ３.その業界のメーカーを取り込む</br>
商品を様々な場面と紐づけることにより、商品の認知度が上がります。また、メーカーの参入でサイト内の情報のやり取りの活発化が見込まれます。</br>
</br>
また、ログイン後にしか内容が見えないようにすることにより、興味のない対象外の方を遮断することができ健全なサイト運営を目指します。</br>
情報の流通が多くない分野で使用し、交流を活発化させ各現場で起こり得る課題の早期解決を目指します。</br>
<br/>
<br/>
***
